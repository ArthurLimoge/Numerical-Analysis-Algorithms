...
The plot is not nearly as accurate as the previous ones. The Gumbel approximation only seems to be valid up to a certain point. We can try to study the data with other patterns. [Open to suggestions]